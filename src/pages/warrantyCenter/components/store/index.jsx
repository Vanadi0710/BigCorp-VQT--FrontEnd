...
import { convertProductStatusType } from "../../../../utils/convertType";

const WarrantyCenterStore = () => {
      ...
      render: (product) => (
        <Button
          onClick={async () => {
            ...
            let productDetail = await productAPI.getProduct(product.product._id);
...
export default WarrantyCenterStore;
